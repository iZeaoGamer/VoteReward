...
class Main extends PluginBase {
  ...
  public function rewardPlayer($player, $multiplier) {
    ...
    if($multiplier < 1) {
      $player->sendMessage("§a[§bVoteReward§a] §6You haven't voted on any server lists! §aYou can vote for: §bin game Money ($30,000), §cVoter rank, commands, §dand iron armour! §aVote for us to get these perks at the following links:\n§b1st: §3http://vhcfvote\n§aVote every day to be the top voter!!)");
      return true;
    }
    $clones = [];
